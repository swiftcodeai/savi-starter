        ...
        <BrowserRouter>
          <Layout>
            <Routes>
              ...
              <Route path={LessonSequence["3.2.1"]} element={<WordSpellingGame />} />
              <Route path={LessonSequence["3.2.2"]} element={<WordSpellingGame />} />
              <Route path={LessonSequence["3.2.3"]} element={<WordSpellingGame />} />
              <Route path={LessonSequence["3.2.4"]} element={<WordSpellingGame />} />
              <Route path={LessonSequence["3.2.5"]} element={<WordSpellingGame />} />
